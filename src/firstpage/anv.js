  ...
  return (
    <header className=" row w-full text-white sc1 z-50">
      <div className=" m-auto justify-between p-4">
        {/* Left: Logo */}
        <img
          src="https://omn-alpha.netlify.app/resources/img/logo-white.png"
          alt="h"
          className="logo"
        />
        {/* Right: Links */}
        <nav className="hidden md:flex space-x-4 mr-5 sc1-nav">
          ...
          <a href="#sc4">How it works</a>
          <a href="#sc5">Our cities </a>
        ...
        {isMenuOpen && (
          <ul className="md:hidden ">
            ...
            <li>
              <a href="#sc4" className="block ">
                How it works
              </a>
            </li>
            <li>
              <a href="#sc5" className="block ">
                Our cities{" "}
              </a>
            </li>
            <li>
              <a href="#sc7" className="block ">
                Sign up
              </a>
            </li>
          </ul>
